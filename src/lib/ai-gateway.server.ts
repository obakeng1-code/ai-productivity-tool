...
export const FORMATTING_RULES =
  "CRITICAL FORMATTING RULES: Output strictly in Markdown. Use --- directly under headers. Max 2 sentences per point. NO nested bullet points (single-level only). Tables max 10 words per cell. Strip all conversational filler.";
